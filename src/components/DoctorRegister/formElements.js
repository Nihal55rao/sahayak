export const inputFormElements=[
    ...
    {
        name:"specialization",placeholder:"specialization", label:"Specialization", 
        variant:"outlined", fullWidth:true,required:true, xs:12,sm:6
    },
    {
        name:"experience",type:"number",placeholder:"experience", label:"Experience", 
        variant:"outlined", fullWidth:true,required:true, xs:12,sm:6
    },
    {
        name:"Qualification",placeholder:"Qualification", label:"Qualification", 
        variant:"outlined", fullWidth:true,required:true, xs:12,sm:6
    },
    {
        name:"HospitalId",placeholder:"HospitalId", label:"Hospital_Id", 
        variant:"outlined", fullWidth:true,required:true, xs:12,sm:6
    },
